proxy:
  host: chi-bl-02.net.arkadin.lan
  driver: junos
dc: chi
region: noram
roles:
...
configuration:
  ...
  interfaces:
    interface:
    - description: X:chi-lf-01:et-0/0/49:fabric
      gigether-options:
        ieee-802.3ad:
          bundle: ae1
      name: et-0/0/0
    - description: X:chi-lf-02:et-0/0/49:fabric
      gigether-options:
        ieee-802.3ad:
          bundle: ae2
      name: et-0/0/1
    - description: X:chi-bl-01:et-0/0/3:back-to-back
      gigether-options:
        ieee-802.3ad:
          bundle: ae0
      name: et-0/0/3
    - description: Q:chi-ce-01:xe-0/0/47:edge
      ether-options:
        ieee-802.3ad:
          bundle: ae11
      name: xe-0/1/0
    - description: Q:chi-ce-02:xe-0/0/47:edge
      ether-options:
        ieee-802.3ad:
          bundle: ae12
      name: xe-0/1/1
    - description: Q:chicore02:gi4/10:legacy-integration
      gigether-options:
        '@':
      ...
      name: xe-0/1/6
      unit:
      - description: X:sjcixrt02:gi0/0/3.513:backbone
        family:
          inet:
            address:
            - name: 172.30.251.9/30
          mpls:
          - null
        name: 513
        vlan-id: 513
    ...
    - aggregated-ether-options:
        lacp:
          periodic: fast
      description: X:chi-bl-01:ae0:back-to-back
      mtu: 9234
      name: ae0
      unit:
      - family:
    ...
    - aggregated-ether-options:
        lacp:
          ...
          - null
          periodic: fast
      description: X:chi-lf-01:ae2:fabric
      name: ae1
      unit:
      - family:
          inet:
    ...
    - aggregated-ether-options:
        lacp:
          ...
          - null
          periodic: fast
      description: X:chi-lf-02:ae2:fabric
      name: ae2
      unit:
      - family:
          inet:
    ...
    - aggregated-ether-options:
        lacp:
          ...
          - null
          periodic: fast
      description: Q:chi-ce-01:ae2:edge
      name: ae11
      unit:
      - family:
          inet:
    ...
    - aggregated-ether-options:
        lacp:
          ...
          - null
          periodic: fast
      description: Q:chi-ce-02:ae2:edge
      name: ae12
      unit:
      - family:
          inet:
    ...
    ospf:
      ...
      - interface:
        ...
        - name: lo0.0
          ...
          - null
        - '@':
            comment: /* ospf metric raised so that path through atlanta is preferred
              due to better latency for majority of sites */
          authentication:
            md5:
            - key: $9$GTUDH.PQn/Ap0RSrlMWg4aGik
              name: 1
          dead-interval: 3
          hello-interval: 1
          interface-type: p2p
