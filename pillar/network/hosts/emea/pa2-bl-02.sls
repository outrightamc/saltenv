...
# 1580 bytes (1500 ethernet payload + 14 Ethernet + 50 VXLAN (8+8+14+20) + 12 MPLS + 4 VLAN).
  - { name: xe-0/1/4, descr: 'E:COLT_PAR/FRA/LE-517467:NTT-SID_SID-EU-01611459:tau-bl-02:backbone', state: enable, mtu: 1580,
  unit: {id: 0, descr: 'X:tau-bl-01:xe-0/1/4.0', address: 172.30.251.21/30, mpls: true}}

# RPM PROBES
rpm:
  - { owner: 'telemetry', dst_hostname: 'tau-bl-01', src_ip: 172.30.251.21, dst_ip: 172.30.251.22 }
