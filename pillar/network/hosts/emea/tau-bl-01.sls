...
# 1580 bytes (1500 ethernet payload + 14 Ethernet + 50 VXLAN (8+8+14+20) + 12 MPLS + 4 VLAN).
  ...
  unit: {id: 0, descr: 'X:pa2-bl-01:xe-0/1/6.0', address: 172.30.251.22/30, mpls: true}}

# RPM PROBES
rpm:
  - { owner: 'telemetry', dst_hostname: 'pa2-bl-02', src_ip: 172.30.251.22, dst_ip: 172.30.251.21 }
