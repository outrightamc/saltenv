...
# 1580 bytes (1500 ethernet payload + 14 Ethernet + 50 VXLAN (8+8+14+20) + 12 MPLS + 4 VLAN).
  - { name: xe-0/1/4, descr: 'E:COLT_PAR/LON/LE-517463:NTT-SID-EU-01611473:ld4-bl-01:backbone', state: enable, mtu: 1580,
  unit: {id: 0, descr: 'X:ld4-bl-01:xe-0/1/4.0', address: 172.30.251.17/30, mpls: true}}
  - { name: xe-0/1/5, descr: 'E:ZAYO_PA2/CHI/ETYX/236544//ZYO :NTT-SID-EU-01611480:chi-bl-01:backbone', state: enable, mtu: 1580,
  unit: {id: 0, descr: 'X:chi-bl-01:xe-0/1/5.0', address: 172.30.251.29/30, mpls: true}}

# RPM PROBES
rpm:
  - { owner: 'telemetry', dst_hostname: 'ld4-bl-01', src_ip: 172.30.251.17, dst_ip: 172.30.251.18 }
